...
const Experience = () => {
    return (
        <div className='border-b border-neutral-900 pb-4'>
            <motion.h2 whileInView={{ y: 0, opacity: 1 }} initial={{ opacity: 0, y: -100 }} transition={{ duration: 0.5 }} className='my-20 text-center text-4xl'>Experience</motion.h2>
            <div>
                {
                            ...
                            <motion.div whileInView={{ x: 0, opacity: 1 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 0.5 }} className='w-full max-w-xl lg:w-3/4'>
                                <h6 className='mb-2 font-semibold'>
                                    ...
                                    <span className='text-sm text-purple-100'>
                                        {experience.company}{experience.link && ' - '}
                                    </span>
                                    {experience.link &&
                                        <a className='text-sm text-blue-200 underline' href={experience.link} target='_blank'>
                                            Certificate
                                        </a>}
                                </h6>
